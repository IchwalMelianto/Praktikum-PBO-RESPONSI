...
public class FE_Model {
    ...
    String IDBuku, JudulBuku, GenreBuku, Penulis, Penerbit, Lokasi, Stok;
    ...
    public void updateData(String IDBuku, String JudulBuku, String GenreBuku, String Penulis, String Penerbit, String Lokasi, String Stok){
        int JData=0;
         try {
           String query = "Select * from data_buku WHERE ID='"+IDBuku+"'";
           ...
           while (resultSet.next()){ 
             ...
             if (JData==1) {
                query = "UPDATE data_buku SET JudulBuku='" + JudulBuku + "',GenreBuku='" + GenreBuku + "',Penulis='" + Penulis + "',Penerbit='" + Penerbit + "',Lokasi='" + Lokasi + "',Stok='" + Stok + "' WHERE ID='"+IDBuku+"'";
